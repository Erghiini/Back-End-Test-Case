...
import { ReturnBookService } from './return-books.service';
import { get } from 'http';

@Controller('returnBooks')
export class ReturnBooksController{
    constructor (private readonly returnBookService: ReturnBookService) {}
    
    @Get()
    async findAll() {
        return await this.returnBookService.findAll()
    }
